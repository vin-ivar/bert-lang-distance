...
class CrfTagger(Model):
    ...
    def forward(self,  # type: ignore
                ...
                ner_tags: torch.LongTensor = None,
        ...
        words : ``Dict[str, torch.LongTensor]``, required
            ...
            token in your input.
        ner_tags : ``torch.LongTensor``, optional (default = ``None``)
        ...
        if ner_tags is not None:
            ...
            log_likelihood = self.crf(logits, ner_tags, mask)
            ...
            for metric in self.metrics.values():
                metric(class_probabilities, ner_tags, mask.float())
            if self.calculate_span_f1:
                self._f1_metric(class_probabilities, ner_tags, mask.float())
