...
@Model.register("wordpiece_tagger")
class WordpieceTagger(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(WordpieceTagger, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        if pos_tags is not None:
            ...
            if self._f1_metric is not None:
                self._f1_metric(logits, pos_tags, mask.float())
    ...
    def decode(self, output_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        for predictions in predictions_list:
            ...
            tags = [self.vocab.get_token_from_index(x, namespace="pos")
